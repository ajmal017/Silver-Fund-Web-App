...
class Position(models.Model):
    ...
    asset_type = models.CharField(verbose_name="pos_type", max_length=40, null=True, blank=True)
...
class Trade(models.Model):
    trade_id = models.CharField(verbose_name="trade_id", max_length=40, null=True, blank=True)
    asset_id = models.CharField(verbose_name="asset_id", max_length=40, null=True, blank=True)
...
class ForeignExchange(models.Model):
    ...
    date = models.DateTimeField(verbose_name="date_", null=True, blank=True)
    exchange_rate = models.FloatField(verbose_name="exchange_rate", null=True, blank=True)
    thirty_day_rate = models.FloatField(verbose_name="thirty_day_rate", null=True, blank=True)
    ninety_day_rate = models.FloatField(verbose_name="ninety_day_rate", null=True, blank=True)
    one_eighty_day_rate = models.FloatField(verbose_name="one_eighty_day_rate", null=True, blank=True)
    one_year_rate = models.FloatField(verbose_name="one_year_rate", null=True, blank=True)
    two_year_rate = models.FloatField(verbose_name="two_year_rate", null=True, blank=True)
    three_year_rate = models.FloatField(verbose_name="three_year_rate", null=True, blank=True)
    five_year_rate = models.FloatField(verbose_name="five_year_rate", null=True, blank=True)
    seven_year_rate = models.FloatField(verbose_name="seven_year_rate", null=True, blank=True)
    ten_year_rate = models.FloatField(verbose_name="ten_year_rate", null=True, blank=True)
